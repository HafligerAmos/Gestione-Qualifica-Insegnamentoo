...
namespace App\Libraries\PhpSpreadsheet\Writer\Xls;

use App\Libraries\PhpSpreadsheet\Cell\Coordinate;
use App\Libraries\PhpSpreadsheet\Cell\DataType;
use App\Libraries\PhpSpreadsheet\Cell\DataValidation;
use App\Libraries\PhpSpreadsheet\Exception as PhpSpreadsheetException;
use App\Libraries\PhpSpreadsheet\RichText\RichText;
use App\Libraries\PhpSpreadsheet\RichText\Run;
use App\Libraries\PhpSpreadsheet\Shared\StringHelper;
use App\Libraries\PhpSpreadsheet\Shared\Xls;
use App\Libraries\PhpSpreadsheet\Style\Alignment;
use App\Libraries\PhpSpreadsheet\Style\Border;
use App\Libraries\PhpSpreadsheet\Style\Color;
use App\Libraries\PhpSpreadsheet\Style\Conditional;
use App\Libraries\PhpSpreadsheet\Style\Fill;
use App\Libraries\PhpSpreadsheet\Style\Protection;
use App\Libraries\PhpSpreadsheet\Worksheet\PageSetup;
use App\Libraries\PhpSpreadsheet\Worksheet\SheetView;
use App\Libraries\PhpSpreadsheet\Writer\Exception as WriterException;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \App\Libraries\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var \App\Libraries\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
     ...
     *
     * @see \App\Libraries\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close()
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \App\Libraries\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
    ...
    private function writeBreaks()
    {
        ...
        foreach ($this->phpSheet->getBreaks() as $cell => $breakType) {
            ...
            switch ($breakType) {
                case \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet::BREAK_COLUMN:
                    // Add to list of vertical breaks
                    $vbreaks[] = Coordinate::columnIndexFromString($coordinates[0]) - 1;

                    break;
                case \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet::BREAK_ROW:
                    // Add to list of horizontal breaks
                    $hbreaks[] = $coordinates[1];

                    break;
                case \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet::BREAK_NONE:
                default:
                    // Nothing to do
                    break;
            }
     ...
     * Get Escher object.
     *
     * @return \App\Libraries\PhpSpreadsheet\Shared\Escher
     */
     ...
     * Set Escher object.
     *
     * @param \App\Libraries\PhpSpreadsheet\Shared\Escher $pValue
     */
    public function setEscher(\App\Libraries\PhpSpreadsheet\Shared\Escher $pValue = null)
    {
        $this->escher = $pValue;
    }
    ...
    private function writeCFRule(Conditional $conditional)
    {
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \App\Libraries\PhpSpreadsheet\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;

                    break;
                case \App\Libraries\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;

                    break;
                case \App\Libraries\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;

                    break;
                case \App\Libraries\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;

                    break;
                case \App\Libraries\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLEACCOUNTING:
