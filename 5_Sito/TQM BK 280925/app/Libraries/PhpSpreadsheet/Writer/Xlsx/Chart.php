...
use App\Libraries\PhpSpreadsheet\Chart\Axis;
use App\Libraries\PhpSpreadsheet\Chart\DataSeries;
use App\Libraries\PhpSpreadsheet\Chart\DataSeriesValues;
use App\Libraries\PhpSpreadsheet\Chart\GridLines;
use App\Libraries\PhpSpreadsheet\Chart\Layout;
use App\Libraries\PhpSpreadsheet\Chart\Legend;
use App\Libraries\PhpSpreadsheet\Chart\PlotArea;
use App\Libraries\PhpSpreadsheet\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\App\Libraries\PhpSpreadsheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet $pSheet
     ...
     * @throws WriterException
     */
    private function writePlotArea(XMLWriter $objWriter, \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, Title $xAxisLabel = null, Title $yAxisLabel = null, Axis $xAxis = null, Axis $yAxis = null, GridLines $majorGridlines = null, GridLines $minorGridlines = null)
    {
        if ($plotArea === null) {
            return;
        }
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \App\Libraries\PhpSpreadsheet\Chart\Layout $chartLayout Chart layout
     *
     * @throws WriterException
     */
