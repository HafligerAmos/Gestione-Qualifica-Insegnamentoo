...
class Style extends WriterPart
{
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \App\Libraries\PhpSpreadsheet\Style\Style $pStyle Style
     * @param Spreadsheet $spreadsheet Workbook
     *
     * @throws \App\Libraries\PhpSpreadsheet\Writer\Exception
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \App\Libraries\PhpSpreadsheet\Style\Style $pStyle, Spreadsheet $spreadsheet)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @throws \App\Libraries\PhpSpreadsheet\Writer\Exception
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \App\Libraries\PhpSpreadsheet\Style\Style $pStyle)
    {
        // dxf
     ...
     * @throws \App\Libraries\PhpSpreadsheet\Writer\Exception
     *
     * @return \App\Libraries\PhpSpreadsheet\Style\Style[] All styles in PhpSpreadsheet
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \App\Libraries\PhpSpreadsheet\Style\Style $style */
