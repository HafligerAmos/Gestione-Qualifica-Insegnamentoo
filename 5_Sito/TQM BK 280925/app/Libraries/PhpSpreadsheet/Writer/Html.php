...
use App\Libraries\PhpSpreadsheet\Cell\Cell;
...
use App\Libraries\PhpSpreadsheet\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
     ...
     *
     * @param Worksheet $pSheet \App\Libraries\PhpSpreadsheet\Worksheet\Worksheet
    ...
    /**
     * Create CSS style (\App\Libraries\PhpSpreadsheet\Style\Alignment).
     *
     * @param Alignment $pStyle \App\Libraries\PhpSpreadsheet\Style\Alignment
     *
     * @return array
     */
    ...
    /**
     * Create CSS style (\App\Libraries\PhpSpreadsheet\Style\Font).
     *
     * @param Font $pStyle
     *
     * @return array
        ...
        foreach ($pValues as $cellAddress) {
            ...
            if ($writeCell) {
                ...
                if (!$this->useInlineCss) {
                    ...
                    //** Necessary redundant code for the sake of \App\Libraries\PhpSpreadsheet\Writer\Pdf **
