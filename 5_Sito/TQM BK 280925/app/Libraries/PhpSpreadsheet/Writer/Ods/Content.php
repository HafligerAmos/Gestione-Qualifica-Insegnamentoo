...
use App\Libraries\PhpSpreadsheet\Worksheet\Row;
use App\Libraries\PhpSpreadsheet\Worksheet\Worksheet;
use App\Libraries\PhpSpreadsheet\Writer\Exception;
use App\Libraries\PhpSpreadsheet\Writer\Ods;
use App\Libraries\PhpSpreadsheet\Writer\Ods\Cell\Comment;
...
class Content extends WriterPart
{
    ...
    private function writeCells(XMLWriter $objWriter, Row $row)
    {
        ...
        while ($cells->valid()) {
            /** @var \App\Libraries\PhpSpreadsheet\Cell\Cell $cell */
            $cell = $cells->current();
     ...
     * @param Cell $cell
     *
     * @throws \App\Libraries\PhpSpreadsheet\Exception
     */
