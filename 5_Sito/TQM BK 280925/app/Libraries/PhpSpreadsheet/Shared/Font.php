...
namespace App\Libraries\PhpSpreadsheet\Shared;
...
class Font
{
     ...
     *
     * @param \App\Libraries\PhpSpreadsheet\Style\Font $font Font object
     * @param RichText|string $cellText Text to calculate width
     * @param int $rotation Rotation angle
     * @param null|\App\Libraries\PhpSpreadsheet\Style\Font $defaultFont Font object
     *
     * @return int Column width
     */
    public static function calculateColumnWidth(\App\Libraries\PhpSpreadsheet\Style\Font $font, $cellText = '', $rotation = 0, \App\Libraries\PhpSpreadsheet\Style\Font $defaultFont = null)
    {
     ...
     *
     * @param string $text
     * @param \App\Libraries\PhpSpreadsheet\Style\Font
     * @param int $rotation
     *
     ...
     * @return int
     */
    public static function getTextWidthPixelsExact($text, \App\Libraries\PhpSpreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     * @param \App\Libraries\PhpSpreadsheet\Style\Font $font
     * @param int $rotation
     *
     * @return int Text width in pixels (no padding added)
     */
    public static function getTextWidthPixelsApprox($columnText, \App\Libraries\PhpSpreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     *
     * @param \App\Libraries\PhpSpreadsheet\Style\Font $font The workbooks default font
     * @param bool $pPixels true = return column width in pixels, false = return in OOXML units
     *
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(\App\Libraries\PhpSpreadsheet\Style\Font $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(\App\Libraries\PhpSpreadsheet\Style\Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
