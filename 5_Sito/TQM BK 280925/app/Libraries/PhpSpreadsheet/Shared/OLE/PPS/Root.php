...
namespace App\Libraries\PhpSpreadsheet\Shared\OLE\PPS;
...
use App\Libraries\PhpSpreadsheet\Shared\OLE\PPS;
...
class Root extends PPS
{
    ...
    {
        $this->tempDirectory = \App\Libraries\PhpSpreadsheet\Shared\File::sysGetTempDir();
    ...
    /**
     * Saving big data (PPS's with data bigger than \App\Libraries\PhpSpreadsheet\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param int $iStBlk
    ...
    /**
     * get small data (PPS's with data smaller than \App\Libraries\PhpSpreadsheet\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param array &$raList Reference to array of PPS's
     */
