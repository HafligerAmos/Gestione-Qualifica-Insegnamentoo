...
use App\Libraries\PhpSpreadsheet\Document\Properties;
use App\Libraries\PhpSpreadsheet\NamedRange;
use App\Libraries\PhpSpreadsheet\Reader\Xlsx\Chart;
use App\Libraries\PhpSpreadsheet\ReferenceHelper;
...
use App\Libraries\PhpSpreadsheet\Shared\Drawing;
use App\Libraries\PhpSpreadsheet\Shared\File;
use App\Libraries\PhpSpreadsheet\Shared\Font;
...
use App\Libraries\PhpSpreadsheet\Worksheet\AutoFilter\Column;
                                        ...
                                        if ($xmlDrawing->oneCellAnchor) {
                                            foreach ($xmlDrawing->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill) {
                                                    ...
                                                    $objDrawing = new \App\Libraries\PhpSpreadsheet\Worksheet\Drawing();
    ...
    private static function readStyle(Style $docStyle, $style)
    {
        ...
        if (isset($style->font)) {
            ...
            if (isset($style->font->u) && !isset($style->font->u['val'])) {
                $docStyle->getFont()->setUnderline(\App\Libraries\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u) && !isset($run->rPr->u['val'])) {
                            $objText->getFont()->setUnderline(\App\Libraries\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
