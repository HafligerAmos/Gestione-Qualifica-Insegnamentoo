...
namespace App\Libraries\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
    ...
    public static function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \App\Libraries\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
