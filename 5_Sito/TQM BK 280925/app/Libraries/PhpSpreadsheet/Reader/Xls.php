...
namespace App\Libraries\PhpSpreadsheet\Reader;
...
use App\Libraries\PhpSpreadsheet\NamedRange;
use App\Libraries\PhpSpreadsheet\RichText\RichText;
use App\Libraries\PhpSpreadsheet\Shared\CodePage;
use App\Libraries\PhpSpreadsheet\Shared\Date;
use App\Libraries\PhpSpreadsheet\Shared\Escher;
use App\Libraries\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use App\Libraries\PhpSpreadsheet\Shared\File;
use App\Libraries\PhpSpreadsheet\Shared\OLE;
use App\Libraries\PhpSpreadsheet\Shared\OLERead;
...
use App\Libraries\PhpSpreadsheet\Style\Borders;
use App\Libraries\PhpSpreadsheet\Style\Font;
use App\Libraries\PhpSpreadsheet\Style\NumberFormat;
use App\Libraries\PhpSpreadsheet\Style\Protection;
use App\Libraries\PhpSpreadsheet\Style\Style;
use App\Libraries\PhpSpreadsheet\Worksheet\MemoryDrawing;
        ...
        foreach ($this->sheets as $sheet) {
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    $width = \App\Libraries\PhpSpreadsheet\Shared\Xls::getDistanceX($this->phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
                    $height = \App\Libraries\PhpSpreadsheet\Shared\Xls::getDistanceY($this->phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);

                    // calculate offsetX and offsetY of the shape
                    $offsetX = $startOffsetX * \App\Libraries\PhpSpreadsheet\Shared\Xls::sizeCol($this->phpSheet, $startColumn) / 1024;
                    $offsetY = $startOffsetY * \App\Libraries\PhpSpreadsheet\Shared\Xls::sizeRow($this->phpSheet, $startRow) / 256;
