		...
		<div class="modal-dialog" style="max-width: 90% !important; width: 90% !important">
			<div class="modal-content">
				...
				<div class="modal-body" style="text-align:justified">
					...
					correttamente.</p>
					<p>Per avere un confronto che sia il più attendibile possibile è necessario, dove possibile, che la qualifica sia effettuata da
					...
					<span class="tab">Intensità con cui il docente si dedica ad ogni singolo allievo.</span><br><br>
					...
					<span class="tab">Trattamento differenziato a seconda del ritmo di lavoro, degli interessi e delle capacità degli allievi.</span><br><br>
					<b>6. Organizzazione - Or</b><br>
					<span class="tab">L'organizzazione della scuola permette di lavorare in un clima e in un ambiente piacevoli.</span>
					<br><br>
					<p>Le valutazioni, da quasi mai a molto spesso, devono rispecchiare la reale situazione. È
					...
					chiedere il supporto del docente che accompagna dal punto di vista pedagogico/didattico (tutor).</p>
